...
- **Certificate Management:** See README Certificate Management section above and `ansible/roles/certificates/README.md`
...
**Architecture:** Control Plane-based infrastructure using Semaphore UI for automation orchestration
